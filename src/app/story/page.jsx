...
export default function Story() {
  return (
    <div className="max-w-7xl mx-auto p-6 flex flex-col items-center text-left justify-center shadow-2xl mt-10">
      ...
      <h1 className="text-3xl font-bold mt-10">About Last Call Trips</h1>
      ...
      <Image
        ...
        width={600}
        height={300}
        className="mt-10 rounded-2xl transition duration-300 hover:shadow-2xl hover:scale-110"
      />
